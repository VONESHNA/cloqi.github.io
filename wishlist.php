    ...
    <div id="page-content" style="background-color: black;">
    	...
    	<div class="page section-header text-center" style="background-color: black;">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width" style="color: rgb(250, 253, 255);">Wish List</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
                	...
                	<form action="#">
                        <div class="wishlist-table table-content table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                    	<th class="product-name text-center alt-font" style="color: rgb(250, 253, 255);">Remove</th>
                                        <th class="product-price text-center alt-font" style="color: rgb(250, 253, 255);">Images</th>
                                        <th class="product-name alt-font" style="color: rgb(250, 253, 255);">Product</th>
                                        <th class="stock-status text-center alt-font" style="color: rgb(250, 253, 255);">Size</th>
                                        <th class="product-price text-center alt-font" style="color: rgb(250, 253, 255);">Unit Price</th>

                                        <!-- <th class="stock-status text-center alt-font" style="color: rgb(250, 253, 255);">Stock Status</th> -->
                                        <th class="product-subtotal text-center alt-font" style="color: rgb(250, 253, 255);">Add to Cart</th>
                                    </tr>
                                </thead>
                                <tbody>
...
foreach($wish as $K=>$v){
 ...
 $grandtotal=$shipping+$subtotal;
                          ?>
                                    ...
                                    <tr>
                                    	<td  onclick="removefromcart('<?php  echo $wishid;?>')" class="product-remove text-center" valign="middle"><i class="icon icon anm anm-times-l text-danger"></i></td>
                                        <td class="product-thumbnail text-center">
                                            <a href="#"><img src="<?php echo $img;?>" alt="" title="" /></a>
                                        </td>
                                        <td class="product-name"><h4 class="no-margin"><a href="#" style="color: rgb(250, 253, 255);"><?php echo $productName;?></a></h4></td>
                                        <td class="product-price text-center"><span class="amount" style="color: rgb(250, 253, 255);"><?php echo ucwords($size);?></span></td>
                                        <td class="product-price text-center"><span class="amount" style="color: rgb(250, 253, 255);">&#8377;<?php echo $sellingprice;?></span></td>
                                        <!-- <td class="stock text-center">
                                            <span class="in-stock " style="color: rgb(250, 253, 255);">in stock</span>
                                        </td> -->

                                        <script type="text/javascript">
                                            
                                            let wishid='<?php echo $wishid;?>';
                                            //alert(wishid);
                                           </script>
                                        


                                        <td class="product-subtotal text-center " onclick="addtocart('<?php echo $wishid;?>')" >  <button type="button" class="btn btn-small " >Add To Cart</button></td>
                                ...
                                <?php }} ?>
                                   ...
                                   <!--  <tr>
                                    	<td class="product-remove text-center" valign="middle"><a href="#"><i class="icon icon anm anm-times-l text-danger"></i></a></td>
                                        <td class="product-thumbnail text-center">
                                            <a href="#"><img src="assets/images/product-images/product-image4.jpg" alt="" title="" /></a>
                                        </td>
                                        <td class="product-name"><h4 class="no-margin"><a href="#" style="color: rgb(250, 253, 255);">Sueded Cotton Pant in Khaki</a></h4></td>
                                        <td class="product-price text-center"><span class="amount" style="color: rgb(250, 253, 255);">$150.00</span></td>
                                        <td class="stock text-center">
                                            <span class="out-stock text-danger" style="color: rgb(250, 253, 255);">Out Of stock</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-name"><h4 class="no-margin"><a href="#" style="color: rgb(250, 253, 255);">Woven Solid Midi Shirt Dress</a></h4></td>
                                        <td class="product-price text-center"><span class="amount" style="color: rgb(250, 253, 255);">$150.00</span></td>
                                        <td class="stock text-center">
                                            <span class="in-stock" style="color: rgb(250, 253, 255);">in stock</span>
                                        </td>
