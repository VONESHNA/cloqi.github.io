...
<!-- Favicon -->
<link rel="shortcut icon" href="./VID-20250112-WA0055_026.jpg" />
<!-- Plugins CSS -->
...
<body class="page-template belle cart-variant1" style="background-color: black;">
                ...
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        <ul id="siteNav" class="site-nav medium center hidearrow">
                            <li class="lvl1 parent megamenu"><a href="index.html" style="color: rgb(241, 244, 247);">Home <i class="anm anm-angle-down-l"></i></a>
                            </li>
                            
                        <li class="lvl1 parent megamenu"><a href="./PRODUCTS CATEGORY.html" style="color: rgb(247, 250, 253);">Product <i class="anm anm-angle-down-l"></i></a>
                        </li>
                        
                        <li class="lvl1"><a href="./PRODUCT DESCRIPTION.html" style="color: rgb(248, 250, 252);"><b>Buy Now!</b> <i class="anm anm-angle-down-l"></i></a></li>
                      </ul>
                    </nav>
                    <!--End Desktop Menu-->
                </div>
                		...
                		<table>
                    		...
                    		<tbody>
                                <tr class="cart__row border-bottom line1 cart-flex border-top">
                                    ...
                                    <td class="cart__meta small--text-left cart-flex-item">
                                        <div class="list-view-item__title">
                                            <a href="#" style="color: rgb(240, 243, 245);">Elastic Waist Dress </a>
                                        </div>
                                    ...
                                    <td class="cart__price-wrapper cart-flex-item">
                                        <span class="money" style="color: rgb(240, 243, 245);">$735.00</span>
                                    </td>
                                    ...
                                    <td class="text-right small--hide cart-price">
                                        <div><span class="money" style="color: rgb(240, 243, 245);">$735.00</span></div>
                                    </td>
                                ...
                                <tr class="cart__row border-bottom line1 cart-flex border-top">
                                    ...
                                    <td class="cart__meta small--text-left cart-flex-item">
                                        <div class="list-view-item__title">
                                            <a href="#" style="color: rgb(240, 243, 245);">3/4 Sleeve Kimono Dress</a>
                                        </div>
                                        <div class="cart__meta-text" style="color: rgb(240, 243, 245);">
                                ...
                                <tr class="cart__row border-bottom line1 cart-flex border-top">
                                    ...
                                    <td class="cart__meta small--text-left cart-flex-item">
                                        <div class="list-view-item__title">
                                            <a href="#" style="color: rgb(240, 243, 245);">Minerva Dress black</a>
                                        </div>
                                    </td>
                                    <td class="cart__price-wrapper cart-flex-item">
                                        <span class="money" style="color: rgb(240, 243, 245);">$526.00</span>
                                    </td>
                                    <td class="cart__update-wrapper cart-flex-item text-right">
                                        <div class="cart__qty text-center">
                                            <div class="qtyField">
                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 cart__footer">
                            <div class="solid-border">	
                              <div class="row border-bottom pb-2">
                                ...
                                <span class="col-12 col-sm-6 text-right"><span class="money" style="color: rgb(240, 243, 245);">$735.00</span></span>
                              </div>
                              ...
                              <div class="row border-bottom pb-2 pt-2">
                                ...
                                <span class="col-12 col-sm-6 cart__subtotal-title cart__subtotal text-right" style="color: rgb(240, 243, 245);"><span class="money">$1001.00</span></span>
                              </div>
                              ...
                              <p><a href="./CHECKOUT.html">Checkout with Multiple Addresses</a></p>
                            </div>
