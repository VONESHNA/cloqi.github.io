...
$getcustomers=Dbops::getCustomers($con);
$getcustomers['n']>0?$customers=$getcustomers['f']:$customers=[];
...
?>
                ...
                <div class="table-responsive">
                    <table class="table m-0 table-striped">
                        <thead>
                            <tr>
                                <th>
                                    <div class="form-group form-check-custom mb-0 flex-shrink-0"> S. No.
 ...
 <!--                                <th>Mobile</th>
                        ...
                        <tbody>
                            <?php $i=0; foreach($customers AS $k=>$v){ $username=Helper::getusername($v); $useremail=Helper::getemail($v); ?>
                            <tr>
                                <td>
