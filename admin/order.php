...
$getorders=Dbops::getOrders($con);
$getorders['n']>0?$orders=$getorders['f']:$orders=[];
?>
    <!-- Page Content -->
    <main id="main">
                ...
                <div class="table-responsive">
                    <table class="table m-0 table-striped">
                        ...
                        <tbody>
                            <?php 
                            $i=0;
                            $billingDetailsfn=Dbops::getBillingDetail($con);//print_r($billingDetailsfn);
                            ...
                            foreach($billingDetails AS $k=>$v){
                                ...
                                $city=$v['city'];
                                $landmark=$v['landmark'];
                                $orderid='OD'.$v['billtoken'];
                                $billtoken=$v['billtoken'];
                            ...
                            <tr>
                                <td>
                                    <div class="form-group form-check-custom mb-0"><?php echo ++$i ;?>
                                        <!-- <input type="checkbox" class="form-check-input" id="filter-0"> -->
                                    </div>
                                </td>
                                <td><?php echo 'Order Id : '.$orderid.'<br/> Order Date : '.$created;?></td>
                                <!-- <td><?php echo $created;?></td> -->

                                <td><?php echo 'User Name : '.$username.'<br/> User Email : '.$useremail.'<br/> ';?></td>
                                <!-- <td><?php   ?>
                                  
                                </td>
                                <td><?php //echo ;?></td>
                                <td class="text-muted"><i class="ri-map-pin-line align-bottom"></i> <?php// echo $city;?></td>
                                <td class="text-muted"><?php //echo $contact; ?></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="f-w-2 f-h-2 bg-success d-block rounded-circle me-1 fs-xs fw-bolder"></span> <span class="small text-muted"><?php echo $address;?></span>
                                    </div>
                                </td>
                                <td>
                                    <div class="dropdown">
                                ...
                                <thead>
                                <tr><td>S.No.&nbsp;&nbsp;</td><td>Product</td><td>Size&nbsp;&nbsp;</td><td>Category&nbsp;&nbsp;</td><td>Quantity&nbsp;&nbsp;</td><td>Price</td></tr>

                                </thead>
                                <tbody>
                                    <?php $j=0;
                                    $totalprice=0;
                                $data=['con'=>$con, 'billtoken'=>$billtoken];
                                ...
                                <tfoot><tr><td colspan='2'></td><td colspan='3'>Total Billing Amount</td><td>&#8377;<?php echo $totalprice;?></td></tr></tfoot>
                                </table>
                                </td>
                                <td><?php echo 'Name : '.$fullname.'<br/>Contact : '.$contact.'<br/> City : '. $city.'<br/> Address : '. $address.'<br/> Landmark : '.$landmark.'<br/> Pincode : '.$pincode;?></td>
                            </tr>
                            <?php
                             }
                             ?>
