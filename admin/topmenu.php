          ...
          <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-1">
                ...
                <!--   <li><a class="dropdown-item d-flex align-items-center" href="#">Set Visibility</a></li>
                  ...
                  <li class="d-flex py-2 align-items-start">
                    <!-- <button class="btn-icon bg-primary-faded text-primary fw-bolder me-3">Admin</button> -->
                    <div class="d-flex align-items-start justify-content-between flex-grow-1">
                      <div>
                        <p class="lh-1 mb-2 fw-semibold text-body">Admin</p>
                        <p class="text-muted lh-1 mb-2 small">admin@email.co</p>
                      </div>
                  ...
                  <li><a class="dropdown-item d-flex align-items-center" href="./logout">Logout</a></li>
                </ul>
              </div>        <!-- / Profile Menu-->
