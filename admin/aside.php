            ...
            <div data-pixr-simplebar>
                <div class="pb-6">
                    ...
                    <ul class="list-unstyled mb-6">
                        ...
                        <li class="menu-item"><a class="d-flex align-items-center" href="./dashboard.php">
                        ...
                        <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            ...
                            <div class="collapse" id="collapseMenuItemPages">
                                <ul class="submenu">
                                    ...
                                    <li><a href="./categorymanage">Manage Categories</a></li>
                                    <li><a href="./productmanage">Manage Products</a></li>
                        ...
                        <!-- Pages Menu Section-->
                        <li class="menu-section mt-4">Customer</li>
                        <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                                ...
                                <span
                                    class="menu-link">Customer</span></a>
